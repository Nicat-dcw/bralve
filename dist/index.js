...
var _emitter = _interopRequireDefault(require("@smootie/emitter"));
...
var Bralve = /*#__PURE__*/function (_KiwiEmitter) {
  _inherits(Bralve, _KiwiEmitter);
  var _super = _createSuper(Bralve);
  function Bralve() {
      ...
      return new Promise(function (resolve, reject) {
        var req = protocolModule.request(requestOptions, function (res) {
          ...
          res.on('end', function () {
            ...
            _this.emit("request", _objectSpread({
              type: "succeedRequest"
            }, response));
            resolve(response);
          });
